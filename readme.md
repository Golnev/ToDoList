...
ToDoList имеет возможность добавить несколько задач, отображать список задач, показывать определенную задачу, редактировать определенную задачу, удалять задачу и записывать список задач в txt файл.
